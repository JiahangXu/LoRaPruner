...
baseline_pruned_model=/mnt/data/LoRaPruner/gpt4alpaca_llama7b_closeinit_gate_0.5lagST-s20.0-lr5e-05-reglr0.05-warmup4/2023-8-20-20-17/epoch6
...
deepspeed --num_nodes=1 --num_gpus=8 --master_port=16112 train.py \
  ...
  --pretrained_pruned_model $baseline_pruned_model \
  --max_seq_length 1024 \
  --task_name alpacaclean_llama7b_promptlong_FTbased_mark27 \
  --do_train \
  --do_eval \
