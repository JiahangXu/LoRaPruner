...
baseline_pruned_model=/mnt/data/LoRaPruner/llmpruner-5k_llama7b_promptlong_mark84-1-s20.0-lr5e-05-reglr0.05-warmup10/2023-9-11-19-18/epoch14
...
deepspeed --num_nodes=1 --num_gpus=8 --master_port=16112 train.py \
  ...
  --pretrained_pruned_model $baseline_pruned_model \
  --max_seq_length 1024 \
  --task_name gpt4alpaca_llama7b_promptlong_FTbased_mark84LLMQATPromptLong_4e-6 \
  --do_train \
  --do_eval \
