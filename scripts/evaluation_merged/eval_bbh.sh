...
# python ./eval_ppl/eval_ppl.py --max_seq_len 1024 --model_type lora_pruner --base_model ./llama_mergezs --prompt_mark 0

source /home/aiscuser/anaconda3/bin/activate instruct-eval

cd instruct-eval
# python main.py bbh --model_name llama --model_path ./llama_pruned
python main.py bbh --model_name llama --model_path $1 --prompt_mark $2
