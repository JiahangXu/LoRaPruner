...
deepspeed --num_nodes=1 --num_gpus=8 --master_port=16112 train.py \
  ...
  --pretrained_pruned_model /mnt/data/LoRaPruner/alpacagpt4_llama7b_wolayer-s30.0-lr5e-05-reglr0.05-warmup2/2023-6-24-1-34/epoch2 \
  --num_train_epochs 2 \
  --learning_rate 5e-5 \
  --max_seq_length 1024 \
  --task_name finetune_alpacagpt4_llama7b_wolayer \
  --do_train \
