...
baseline_pruned_model=/mnt/data/LoRaPruner/gpt4alpaca_llama7b_prompt_nogate_CubicSpar_mark28-6_selected-s42.3-lr5e-05-reglr0.05-warmup4/2023-9-6-7-7/epoch6
...
deepspeed --num_nodes=1 --num_gpus=8 --master_port=16112 train.py \
  ...
  --pretrained_pruned_model $baseline_pruned_model \
  --max_seq_length 1024 \
  --task_name gpt4alpaca_llama7b_promptlong_FTbased_mark28-6_selected_1.6e-3 \
  --do_train \
  --do_eval \
