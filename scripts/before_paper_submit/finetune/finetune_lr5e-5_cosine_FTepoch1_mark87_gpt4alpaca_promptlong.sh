...
baseline_pruned_model=/mnt/data/LoRaPruner/gpt4alpaca-5k_llama7b_promptlong_mark87-s20.0-lr5e-05-reglr0.05-warmup10/2023-9-2-2-20/epoch14/
...
deepspeed --num_nodes=1 --num_gpus=8 --master_port=16112 train.py \
  ...
  --pretrained_pruned_model $baseline_pruned_model \
  --max_seq_length 1024 \
  --task_name alpacagpt4_llama7b_promptlong_FTbased_mark87_5e-5 \
  --do_train \
  --do_eval \
