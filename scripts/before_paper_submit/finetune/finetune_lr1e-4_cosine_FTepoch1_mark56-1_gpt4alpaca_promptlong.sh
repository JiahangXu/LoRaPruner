...
baseline_pruned_model=/mnt/data/LoRaPruner/gptcleaned5k_llama7b_epoch30_warmup10_spar0.2_middle-s20.0-lr5e-05-reglr0.05-warmup10/2023-8-30-0-16/epoch29
...
deepspeed --num_nodes=1 --num_gpus=8 --master_port=16112 train.py \
  ...
  --pretrained_pruned_model $baseline_pruned_model \
  --max_seq_length 1024 \
  --task_name alpacagpt4_llama7b_promptlong_FTbased_mark56-1_8e-5 \
  --do_train \
  --do_eval \
