...
def get_obqa_dataset(model_args, data_args, training_args, prompt=""):
    print(prompt)
...
def evaluate_obqa(model, model_args, data_args, training_args, additional_args):
    eval_dataset, labels, tokenizer, choices_num = get_obqa_dataset(model_args, data_args, training_args, prompt=PROMPT_WITH_TYPE[additional_args.eval_prompt_type])
