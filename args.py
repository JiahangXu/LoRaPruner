# Modified from https://github.com/huggingface/transformers/blob/main/examples/pytorch/language-modeling/run_clm.py and \
# https://github.com/princeton-nlp/CoFiPruning/blob/main/args.py
...
class AdditionalArguments():
    ...
    block_layer_start: int = field(default=None, metadata={"help": "Finetuning epochs before pruning"})
    block_layer_end: int = field(default=None, metadata={"help": "Finetuning epochs before pruning"})
