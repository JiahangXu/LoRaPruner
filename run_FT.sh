...
nohup bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_a100_4.5B 2e-4 a100_mark28-5_applyall $base_model_path > ./finetune_log/finetune_log_a100_4.5B_2e-4.txt 2>&1 &
nohup bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_a100_4.5B 1e-4 a100_mark28-5_applyall $base_model_path > ./finetune_log/finetune_log_a100_4.5B_1e-4.txt 2>&1 &
nohup bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_a100_4.5B 5e-5 a100_mark28-5_applyall $base_model_path > ./finetune_log/finetune_log_a100_4.5B_5e-5.txt 2>&1 &
nohup bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_a100_4.5B 1e-5 a100_mark28-5_applyall $base_model_path > ./finetune_log/finetune_log_a100_4.5B_1e-5.txt 2>&1 &
