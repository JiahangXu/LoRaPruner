...
# bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_5B 2e-4 mark28-2_LoRaApplyAll $base_model_path
bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_5B 1e-4 mark28-2_LoRaApplyAll $base_model_path
# bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_5B 5e-5 mark28-2_LoRaApplyAll $base_model_path
# bash ./scripts/finetune/FT_llmpruner.sh ./llama_pruned_5B 1e-5 mark28-2_LoRaApplyAll $base_model_path
