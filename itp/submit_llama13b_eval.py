...
def single_job(arg):
    ...
    for prompt_type in [0, pt]:
        ...
        command_list = [
            command_head + f"--file evaluation_llama13b/eval_harness.sh --task_name harness --ckpt_dir /mnt/data/{ckpt_path} --prompt_type {prompt_type} --mark {mark} --node_num 4",
            ...
            command_head + f"--file evaluation_llama13b/eval_c4.sh --task_name c4 --ckpt_dir /mnt/data/{ckpt_path} --prompt_type {prompt_type} --mark {mark} --node_num 4",
            # command_head + f"--file evaluation_llama13b/zeroshot/eval_llama7b_piqa.sh --task_name piqa --ckpt_dir /mnt/data/{ckpt_path} --prompt_type {prompt_type} --mark {mark} --node_num 4",
...
waiting_jobs = [
    ...
    # # mark 36
    ("LoRaPruner/gpt4alpaca_llama13b_prompt_nogate-s20.0-lr5e-05-reglr0.05-warmup4/2023-8-23-5-24/epoch6", "mark36_epoch6", 1),
