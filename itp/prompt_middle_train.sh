...
# python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name alpacaclean --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch8 --file select_layer_pruning/train_alpacacleaned_lr5e-5-reglr0.05-epoch8-warmup4-20%-qv
# python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name gpt4alpaca --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch8 --file select_layer_pruning/train_alpacagpt4-5k_lr5e-5-reglr0.05-epoch8-warmup4-20%-qv
# python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name alpacaclean --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch9 --file select_layer_pruning/train_alpacacleaned_lr5e-5-reglr0.05-epoch9-warmup4-20%-qv
# python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name gpt4alpaca --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch8 --file select_layer_pruning/train_alpacagpt4_lr5e-5-reglr0.05-epoch8-warmup4-20%-qv
# python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name gpt4alpaca --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch9 --file select_layer_pruning/train_alpacagpt4_lr5e-5-reglr0.05-epoch9-warmup4-20%-qv

# python run_sing.py submit --sparsity 0.3 --target sing_octo --task_name alpacaclean --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch8 --file select_layer_pruning/train_alpacacleaned_lr5e-5-reglr0.05-epoch8-warmup4-30%-qv
# python run_sing.py submit --sparsity 0.3 --target sing_octo --task_name alpacaclean --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch9 --file select_layer_pruning/train_alpacacleaned_lr5e-5-reglr0.05-epoch9-warmup4-30%-qv
# python run_sing.py submit --sparsity 0.3 --target sing_octo --task_name gpt4alpaca --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch8 --file select_layer_pruning/train_alpacagpt4_lr5e-5-reglr0.05-epoch8-warmup4-30%-qv
# python run_sing.py submit --sparsity 0.3 --target sing_octo --task_name gpt4alpaca --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup4-epoch9 --file select_layer_pruning/train_alpacagpt4_lr5e-5-reglr0.05-epoch9-warmup4-30%-qv

# python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name alpacaclean --model_name SelectLayer_nogate_llama7b-lr5e-05-reglr0.05-warmup10-epoch30 --file select_layer_pruning/train_alpacacleaned5k_lr5e-5-reglr0.05-epoch30-warmup10-20%-qv
...
python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name alpacaclean --model_name SelectLayer_nogate_llama13b-lr5e-05-reglr0.05-warmup4-epoch10 --file llama13b_training/train_alpacacleaned5k_promptmiddle_lr5e-5-reglr0.05-epoch10-warmup4-20%-qv
python run_sing.py submit --sparsity 0.2 --target sing_octo --task_name gpt4alpaca --model_name SelectLayer_nogate_llama13b-lr5e-05-reglr0.05-warmup4-epoch10 --file llama13b_training/train_alpacagpt4-5k_promptmiddle_lr5e-5-reglr0.05-epoch10-warmup4-20%-qv
