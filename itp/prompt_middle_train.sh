...
python run_sing.py submit --sparsity 0.2 --target sing_research --task_name alpacaclean --model_name SelectLayer_nogate_llama13b-lr5e-05-reglr0.05-warmup4-epoch10 --file llama13b_training/train_alpacacleaned5k_lr5e-5-reglr0.05-epoch10-warmup4-20%-qv
python run_sing.py submit --sparsity 0.2 --target sing_research --task_name gpt4alpaca --model_name SelectLayer_nogate_llama13b-lr5e-05-reglr0.05-warmup4-epoch10 --file llama13b_training/train_alpacagpt4-5k_lr5e-5-reglr0.05-epoch10-warmup4-20%-qv
